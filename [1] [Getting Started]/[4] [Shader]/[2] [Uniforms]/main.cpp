...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		/* Update */
		glUniform1f(glGetUniformLocation(program, "xColor"), 1.0f); // Red
		glUniform1f(glGetUniformLocation(program, "yColor"), 1.0f); // Green
		glUniform1f(glGetUniformLocation(program, "zColor"), 0.1f); // Blue
